...
![ericamitchell]\(/assets/img/people/ericamitchell.jpg)

[![GitHub]\(/assets/img/icons/github.svg){: width="20"}](https://github.com/EricaCMitchell){: .btn} &nbsp;
[![Google Scholar]\(/assets/img/icons/scholar.svg.png){: width="20"}](https://scholar.google.com/citations?user=csXbqssAAAAJ&hl=en){: .btn}
